/**
 * Character Version Visual Grids API
 * Update visual grids (poses, expressions, gestures) for a specific version
 */
...
// PATCH - Update visual grids for a version
export async function PATCH(
    ...
    try {
        ...
        console.error("Update version grids error:", error);
...
// GET - Get visual grids for a version
export async function GET(
    ...
    try {
        ...
        console.error("Get version grids error:", error);
        return NextResponse.json(
