...
export async function PATCH(
    ...
    try {
      ...
      UPDATE story_versions SET 
        ...
        ending_rasa = COALESCE(${body.endingRasa}, ending_rasa),
        ...
        want_stages = COALESCE(${body.wantStages ? JSON.stringify(body.wantStages) : null}::jsonb, want_stages),
        need_stages = COALESCE(${body.needStages ? JSON.stringify(body.needStages) : null}::jsonb, need_stages),
